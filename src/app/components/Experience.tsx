	...
	const experiences = [
		{
			...
			description:
				"Contributed to the development of a real-time crypto trading platform by implementing user-facing features based on designs, integrating APIs, and focusing on creating a responsive and seamless user experience.",
			achievements: [
				"Implemented key features for a real-time crypto trading platform using React and TypeScript, delivering live market data to active traders.",
				"Integrated Orderly Network APIs to handle order management, fetch market data, and display live trade statuses.",
				"Established WebSocket connections for real-time market data updates, enhancing trading speed and accuracy.",
				"Utilized TanStack Query for efficient data fetching, caching, and state synchronization of dynamic market data.",
				"Constructed reusable and accessible UI components following design system standards using shadcn/ui.",
				"Developed interactive data visualizations, including a live Depth Chart with Visx for market depth analysis.",
				"Managed complex form states and validations using React Hook Form and employed Jotai for lightweight global state management.",
				"Contributed to building the Progressive Web App (PWA) version to provide an optimal mobile trading experience.",
				"Worked closely with UI/UX designers and QA teams to ensure the delivery of a high-quality, polished product.",
			],
			technologies: [
				"React",
				"TypeScript",
